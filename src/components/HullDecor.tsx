...
function HullArt() {
  ...
  return (
    <>
      ...
      {/* left */}
      <line x1="11%" y1="25%" x2="28%" y2="25%" />
      <line x1="28%" y1="25%" x2="32%" y2="29%" />
      <circle cx="32%" cy="29%" r="2.6" />
      <line x1="11%" y1="25%" x2="11%" y2="30.5%" />
      <circle cx="11%" cy="30.5%" r="1.8" />
      <line x1="14%" y1="27.5%" x2="20%" y2="27.5%" />
      <rect x="22%" y="23%" width="7" height="7" />
      {/* right (mirror) */}
      <line x1="89%" y1="25%" x2="72%" y2="25%" />
      <line x1="72%" y1="25%" x2="68%" y2="29%" />
      <circle cx="68%" cy="29%" r="2.6" />
      <line x1="89%" y1="25%" x2="89%" y2="30.5%" />
      <circle cx="89%" cy="30.5%" r="1.8" />
      <line x1="80%" y1="27.5%" x2="86%" y2="27.5%" />
      <rect x="71%" y="23%" width="7" height="7" />
    </>
  )
}
